package de.aaronoe.picsplash.components;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            // Log.d(TAG, "clampViewPositionVertical() returned: " + result);
            // Log.e(TAG, "Sensitivity : " + ((1.0 / (float) top) * 10));
            viewDragHelper.setmTouchSlop((float)((1.0 / (float) top) * 10));
    ...
    private boolean backBySpeed(float xvel, float yvel) {
        Log.d(TAG, "backBySpeed() called with: xvel = [" + xvel + "], yvel = [" + yvel + "]");
        switch (dragEdge) {
            case TOP:
            case BOTTOM:
    ...
    private void smoothScrollToY(int finalTop) {
        Log.d(TAG, "smoothScrollToY() called with: finalTop = [" + finalTop + "]");
